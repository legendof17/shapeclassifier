...
function preload() {
    for(let i = 0; i < 100; i++) {
        ...
        circles[i] = loadImage(`../data_generator/data/circle${index}.png`);
        squares[i] = loadImage(`../data_generator/data/square${index}.png`);
        triangles[i] = loadImage(`../data_generator/data/triangle${index}.png`);
    }
}
